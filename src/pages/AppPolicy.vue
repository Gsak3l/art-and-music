<template>
  <div class="container" style="margin-top: 120px;">
    ...
    <p>We use Your Personal data to provide and improve the Service. By using the Service, You agree to the
      ...
      help of the <a href="https://www.freeprivacypolicy.com/free-privacy-policy-generator/AppPolicy.vue"
    ...
    <ul>
      ...
      <li>
        <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;,
          &quot;Us&quot;
          or &quot;Our&quot; in this Agreement) refers to Theodoros Mylonas.</p>
      </li>
      <li>
      ...
      <li>
        <p><strong>Website</strong> refers to Dimitrios Lamprinidis, accessible from <a
            href="https://artandmusic.gr" rel="external nofollow noopener"
            target="_blank">https://artandmusic.gr</a></p>
      </li>
      <li>
    ...
    <ul>
      <li>
        <p>By email: sakellariou@ieee.org</p>
      </li>
      <li>
        <p>By phone number: +30 694 898 1641</p>
      </li>
    </ul>
  </div>
</template>
